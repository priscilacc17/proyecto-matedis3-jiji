...
var setPeopleClasses = function () {
    ...
    $("#economycost").html(""+formatLargeNumber(economyCost));
    $("#nhscost").html(""+formatLargeNumber(nhsCost));
    $("#vaccinationcost").html(""+formatLargeNumber(vaccinationCost));
...
var updateSliders = function () {
    ...
    if (virus.quarantine & virus.distancing) {
        $("#quarantineselector").val("Cuarentena más distanciamiento");
    }
    else if (virus.quarantine) {
        $("#quarantineselector").val("Cuarentena");
    }

    else {
        $("#quarantineselector").val("No medidas");
    }
}
...
$(document).ready(function () {
    ...
    $("#quarantineselector").change(function () {
        if ($(this).val() == "No medidas") {
            virus.quarantine = false;
            virus.distancing = false;
        }
        else if ($(this).val() == "Cuarentena más distanciamiento") {
